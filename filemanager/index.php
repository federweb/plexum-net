...
$CONFIG = '{"lang":"it","error_reporting":false,"show_hidden":true,"hide_Cols":false,"calc_folder":true}';
...
$use_auth = false; // auth handled by auth_gate.php

// Login user name and password
// Users: array('Username' => 'Password', 'Username2' => 'Password2', ...)
// Generate secure password hash - https://tinyfilemanager.github.io/docs/pwd.html
$auth_users = array(
    'admin' => '$2y$10$CnGzATRjUeQGV6NCRZ29OePsF3JfcxWc5zvozKjVfMbtqpFVhccPa', // noname
    'user' => '$2y$10$CnGzATRjUeQGV6NCRZ29OePsF3JfcxWc5zvozKjVfMbtqpFVhccPa' //noname
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="form-group">
                                       <div class="brand">
                                            <APP_TITLE version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K Tiny File Manager">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="" class="text-muted" data-version="<?php echo VERSION; ?>">FM</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <a title="<?php echo lng('Logout') ?>" style="position:absolute; right: 20px; margin-top: 22px;" href="?gate_logout"><?php echo lng('Logout') ?></a>
        <?php else: ?>
            <div class="col-12"><a href="" style="pointer-events: none;" class="float-right text-muted">FM<?php echo '3.0'; ?></a></div>
        <?php endif; ?>
    </div>
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white mb-4 main-nav <?php echo $isStickyNavBar ?>">
        <a class="navbar-brand" href=""> <?php echo 'FM'; ?> </a>
                ...
                <ul class="navbar-nav mr-auto float-right">
                    ...
                    <li class="nav-item avatar dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink-5">
                            ...
                            <a title="<?php echo lng('Logout') ?>" class="dropdown-item nav-link" href="?gate_logout"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lng('Logout') ?></a>
                        </div>
                    </li>
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        .nav-item.avatar.dropdown{display:none;}
        .fa.fa-home{font-size: 1.8em;}
